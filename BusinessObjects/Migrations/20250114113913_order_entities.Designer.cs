...
namespace BusinessObjects.Migrations
{
    ...
    [Migration("20250114113913_order_entities")]
    partial class order_entities
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BusinessObjects.Entities.BlankProductInStock", b =>
                {
                    ...
                    b.ToTable("BlankProductsInStocks");
                });
            ...
            modelBuilder.Entity("BusinessObjects.Entities.DesignComponentPosition", b =>
                {
                    b.HasOne("BusinessObjects.Entities.DesignPosition", "DesignPosition")
                        .WithMany()
                        .HasForeignKey("DesignPositionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
